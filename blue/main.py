...
DOTMATRIX_STARTUP_MESSAGE = "BIPS"                          ### check and customise ###
...
UBIDOTS_CLIENT = "sky"                                       ### check and customise ###
UBIDOTS_MQTT_PORT = 1883
UBIDOTS_MQTT_TOPIC = b"/v1.6/devices/sky"                    ### check and customise ###
UBIDOTS_TOKEN = "BBUS-xpZrDgHFhEyAKn2REnsjmkCWzYJXr7"        ### check and customise ###
